...
the brief owner manual and all 44 mode descriptions. Normal non-erase updates
preserve camera settings. `VALUECAM_SD.BIN` is the microSD fallback image;
rename it to `VALUECAM.BIN` on the card. `SHA256SUMS` contains release checksums.
